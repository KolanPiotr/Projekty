...
public class Player {
    ...
    private final TreeSet<Card> _hand = new TreeSet<>(Card::compare);
    private final ArrayList<Integer> _comboIndexList = new ArrayList<>();
    public String getNick(){ return _nick; }
    public TreeSet<Card> gethand(){ return _hand; }
    ...
    public void exchange(ArrayList<Card> deck, ArrayList<Integer> indexes){
        Iterator<Card> value;
